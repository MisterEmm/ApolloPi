...
ADAFRUIT_IO_KEY = 'YOUR_ADAFRUIT_IO_KEY' # Substitute for your individual IO key
ADAFRUIT_IO_USERNAME = 'YOUR_ADAFRUIT_IO_USERNAME' # Substitute for your individual IO username
aio = Client(ADAFRUIT_IO_USERNAME, ADAFRUIT_IO_KEY)
picam_feed = aio.feeds('YOUR_ADAFRUIT_IO_IMAGE_FEED') # Substitute for your image feed name
